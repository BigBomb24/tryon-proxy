...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const text = data && data.candidates && data.candidates[0] && data.candidates[0].content && data.candidates[0].content.parts && data.candidates[0].content.parts[0] && data.candidates[0].content.parts[0].text || 'Unable to generate analysis.';
